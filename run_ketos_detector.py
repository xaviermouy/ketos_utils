...
parser.add_argument(
    "--tmp_dir", type=str, default="./tmp", help="Path of temporary folder."
)
parser.add_argument(
    "--deployment_file",
    type=str,
...
model, audio_repr = ketos.neural_networks.load_model_file(
    args.model, args.tmp_dir, load_audio_repr=True
)
...
for idx, file in enumerate(files):
    try:
        ...
        temp_file_name = decimate(
            file, args.tmp_dir, spec_config["rate"], channel=args.channel
        )
